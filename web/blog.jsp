<%-- 
    Document   : blog
    Created on : 13/10/2022, 11:07:11 PM
    Author     : usuario
--%>
...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      <div class="page-header d-flex align-items-center" style="background-image: url('assets/img/background.jpg');">
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="assets/img/varo.jpg" alt="" class="img-fluid">
              </div>

              <p class="post-category">Pintura</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <p class="post-category">Animación</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="assets/img/marina.jpg" alt="" class="img-fluid">
              </div>

              <p class="post-category">Performance</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="assets/img/post4.jpeg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="assets/img/post5.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="assets/img/post6.jpg" alt="" class="img-fluid">
              </div>
